...
Umbrella telemetry for the NugetWorld suite. One registration fans health, network, API, upload, sync, background, device, and crash events into a single export path.
